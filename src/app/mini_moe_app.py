...
# 固定路径（不提供 UI 切换）
# =============================
CONFIG_PATH = "configs/model/mini-moe.yaml"
CKPT_PATH = "mini-moe-checkpoint.pth"
TOKENIZER_PATH = "checkpoints"

# =============================
# Streamlit page setup
# =============================
st.set_page_config(page_title="Mini MOE Chat", page_icon="🤖", layout="centered")
st.title("🤖 Mini MOE Chat UI")
...
def load_model_and_tokenizer(
    ...
    model_cfg["config"]["use_aux_loss"] = False
